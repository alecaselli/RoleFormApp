...
public class EquipaggiamentoOld {
    private String nome;
    ...
    public EquipaggiamentoOld(String nome, StringBuffer descrizione, String tipo, int costo, int peso, int capacita, String subtipo) {
        this.nome = nome;
    ...
    public boolean isNonEquipaggiabile(){
        return tipobase.get(tipobase.size()-1).equals(this.getTipo());
    }
