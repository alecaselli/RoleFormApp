...
public class Equipaggiamento extends Descrivibile {
    private static final List<String> subtipobase = new ArrayList<String>(Arrays.asList("arma da guerra a distanza", "arma da guerra da mischia", "arma semplice a distanza", "arma semplice da mischia", "armatura leggera", "armatura media", "armatura pesante", "attrezzo", "equipaggiamento da avventura", "scudo"));
