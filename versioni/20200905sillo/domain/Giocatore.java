...
public class Giocatore extends Descrivibile {
    ...
    private String eta;
    private StringBuffer noteGiocatore;
    ...
    public Giocatore(String nome,
                     ...
                     int livello,
                     int puntiEsperienza,
                     int puntiFerita, int ndadi, int puntistat, String eta,
                     String iniziativa,
                     int modCompetenza,
                     int capacitaBorsa,
                     int puntiFeritaMax, int dado, int classeArmatura, StringBuffer noteGiocatore,
                     StringBuffer noteAvvenura, StringBuffer allineamento,
                     StringBuffer lingua,
                     Valuta portafoglio,
                     Classe classe,
                     Razza razza,
        ...
        this.noteGiocatore = noteGiocatore;
    ...
    public StringBuffer getNoteGiocatore() {
        return noteGiocatore;
    }

    public void setNoteGiocatore(StringBuffer noteGiocatore) {
        this.noteGiocatore = noteGiocatore;
    }
...
/*
    ...
    /* metodi non base*/
    public void aggiungiNoteGiocatore(StringBuffer note){
        this.noteGiocatore.append(note);
    }
    ...
    public void inizializzazionePG(){
        ...
        this.aggiungiNoteGiocatore(this.classe.getDescrizionePrivilegiPoteri());
        this.aggiungiNoteGiocatore(this.classe.getCompetenza());
